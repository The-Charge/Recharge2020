...
positionControlBtn = new JoystickButton(buttonBox, 3);
positionControlBtn.whileHeld(new PositionsControl());
rotationControlBtn = new JoystickButton(buttonBox, 2);
...
shiftHighBtn.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("PositionsControl", new PositionsControl());
