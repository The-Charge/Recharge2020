...
public JoystickButton animateLED;
...
animateLED = new JoystickButton(buttonBox,2);
animateLED.whileHeld(new AnimateLED());
...
shiftHighBtn.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("AnimateLED", new AnimateLED());
