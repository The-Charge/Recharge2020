...
public JoystickButton arcadeDriveBtn;
...
arcadeDriveBtn = new JoystickButton(rightJoystick, 4);
arcadeDriveBtn.whenPressed(new ArcadeDriveCmd());
quarterSpeedBtn = new JoystickButton(rightJoystick, 4);
zeroBalls = new JoystickButton(rightJoystick, 3);
zeroBalls.whenPressed(new BallDetector());
...
shiftHighBtn.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("ArcadeDriveCmd", new ArcadeDriveCmd());
        SmartDashboard.putData("BallDetector", new BallDetector());
