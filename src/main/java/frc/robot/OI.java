...
public JoystickButton manualClimbUpBtn;
public JoystickButton manualClimbDownBtn;
...
manualClimbDownBtn = new JoystickButton(buttonBox, 4);
manualClimbDownBtn.whileHeld(new ManualClimbDown());
manualClimbUpBtn = new JoystickButton(buttonBox, 3);
manualClimbUpBtn.whileHeld(new ManualClimbUp());
