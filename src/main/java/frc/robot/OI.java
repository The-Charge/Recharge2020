...
public JoystickButton stopperBtn;
...
stopperBtn = new JoystickButton(leftJoystick, 3);
stopperBtn.whenPressed(new StopperCommand());
...
shiftHighBtn.whenPressed(new ShiftHigh());
        ...
        SmartDashboard.putData("StopperCommand", new StopperCommand());
