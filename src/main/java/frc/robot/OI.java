...
import frc.robot.subsystems.PressureGauge;
...
shiftHighBtn.whenPressed(new ShiftHigh());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //SmartDashboard.putNumber("AI Pressure Output", new PressureGauge())
        SmartDashboard.putNumber("AI Voltage", PressureGauge.getPsi(PressureGauge.ai.getAverageVoltage()));
    }
