...
indexer = new Indexer();
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //have one of these options selected before auton
        chooser.addObject("LeftTrenchRun", new LeftTrenchRun());
        chooser.addObject("MiddleTrenchRun",new MiddleTrenchRun());
        chooser.addObject("RightTrenchRun", new RightTrenchRun());
        chooser.addObject("WaitMoveShoot", new WaitMoveShoot());
        chooser.addObject("ShootStraightMove", new ShootStraightMove());
