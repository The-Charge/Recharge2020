...
private WPI_TalonFX leftBackMotor;
	...
	*/
    ...
    //TODO: Motion Magic (all values still need to be changed, these are values for plybot)
    ...
    */
    ...
    // FIXME: Rename this to turnPIDController
    // That way, it's clear that it shouldn't be used for driving X feet
...
*/
    ...
    public void periodic() {
        ...
        // FIXME: Would recommend throwing the following on the smart dashboard:
    ...
    //FIXME: Nothing should need the gyro itself.
    // Remove this method, anything using getGyro (didn't see anything) should probably be using getGyroYaw
    ...
    public void MotionMagicInit(double distance) {
        ...
        //FIXME: If you aren't using code, remove it. 
    ...
    public boolean isAtPIDDestination() {
        // FIXME: Would break this up into multiple lines, like:
        // boolean atLeftPosition = //part that handles the left side
        // boolean atRightPosition = //part that handle the right side
        // return atLeftPosition || atRightPosition;
    ...
    //FIXME: If you aren't using code, remove it. 
    // We have git if we ever need to get code back
    // If you're saving it for later (ie: difference between plybot and actual), add a //TODO
/*
