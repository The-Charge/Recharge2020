...
*/
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("TurnPositionError", turnPIDController.getPositionError());
        SmartDashboard.putNumber("Gyro Positions", getGyroYaw());
        SmartDashboard.putNumber("Current Motor Output:", turnPIDController.calculate(getGyroYaw()));
        SmartDashboard.putNumber("Current Turn Error:", turnPIDController.getPositionError());
        SmartDashboard.putNumber("Current Setpoint:", turnPIDController.getSetpoint());
    }
    ...
    public void MotionMagicInit(double distance) {
        ...
        //Use this code if a correction is need:
    ...
    //Same method, if there are multiple parameters
