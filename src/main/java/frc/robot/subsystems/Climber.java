...
private WPI_TalonSRX climberMotor;
    ...
    public static final int MAX_ENCODER_TICKS = 5000;   //needs to be tuned

    private final static double P_CONSTANT = 0.1;   //needs tuning
    private final static double I_CONSTANT = 0.001;  //needs tuning
	private final static double D_CONSTANT = 0.0;   //needs tuning
    private final static double F_CONSTANT = 0.0;   //needs tuning
    
    private final double ROTATIONS_TO_CLIMB = 35;  //needs tuning
    ...
    private static final int MAX_TICKS_PER_SEC = 934;   //needs tuning
