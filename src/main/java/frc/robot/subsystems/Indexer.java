...
indexerMotorLF = new WPI_TalonSRX(7);


        
indexerMotorRF = new WPI_TalonSRX(2);


        
indexerMotorLB = new WPI_TalonSRX(8);


        
indexerMotorRB = new WPI_TalonSRX(3);


indexerMotorRB.setInverted(true);    
indexerMotorRF.setInverted(true);
    ...
    public void initDefaultCommand() {
        ...
        //setDefaultCommand(new Index(0));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND

        // Set the default command for a subsystem here.
        // setDefaultCommand(new MySpecialCommand());
        // FIXME: Make sure everything's committed, and re-run robot builder.
        // 95% certain the above code in the autogenerated block was changed by hand, which should be avoided
    }
    ...
    public void setPercentSpeedPID(double setSpeed) {
        //FIXME: Need a better smart dashboard key name (would recommend adding class name)
	...
	public void setPercentVBus(double setSpeed) {
        // FIXME: Would remove this method if there's nothing here. Prevents it from being called accidentally
	}
}
