...
indexerMotorLF = new WPI_TalonSRX(0);


        
indexerMotorRF = new WPI_TalonSRX(9);


        
indexerMotorLB = new WPI_TalonSRX(10);


        
indexerMotorRB = new WPI_TalonSRX(11);


indexerMotorRB.setInverted(true);    
indexerMotorRF.setInverted(true);
indexerMotorLB.setInverted(false);    
indexerMotorLF.setInverted(false);
//indexerMotorLB.follow(indexerMotorLF);
//indexerMotorRB.follow(indexerMotorRF);
    ...
    public void setPercentSpeedPID(double setSpeed) {
        ...
        indexerMotorRF.follow(indexerMotorLF);
         indexerMotorLB.follow(indexerMotorLF);
         indexerMotorRB.follow(indexerMotorLF);
