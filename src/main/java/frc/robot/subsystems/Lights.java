...
//  }
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        // Set the default command for a subsystem here.
         setDefaultCommand(new AnimateLED());
    }
   ...
   //how to implement the MovingAverage framework - do we need it
    ...
    public void changeVisionLights()
    {
        ...
        else if (vision.equals("Something") || vision.equals("Not Locked"))
        {
            canifier.setLEDOutput(242, CANifier.LEDChannel.LEDChannelA);
            canifier.setLEDOutput(53, CANifier.LEDChannel.LEDChannelB);
            canifier.setLEDOutput(53, CANifier.LEDChannel.LEDChannelC);
        }
