...
public class Turret extends Subsystem {
    ...
    //Constants aquired from CAD team used for trig calculations:
    public static final double TURRET_SIDE_A = 9.625;
    public static final double TURRET_SIDE_B = 14.544;
